...
| 40 | **STABILISE 4 — SAM prompted from the located animal; SP only** | **done — SP FAIL (gate 4)** | drift gone: disc on animal 93.7%, refused 56/300. SP passes gates 0–3: exact on duplicates (0/22,950), **planted 2 px jitter moves it 1.000× vs incumbent 11.8×**, still frames 1.04× perfect. Fails moving plants at 17×: ECC locks onto the static bar floor (recovers 8.8% of fast-frame motion) | `results/STABILISE4.md`, `stabilise4.json` |
